  ...
  studentsFeatures = [
    {
      ...
      description:
        'Sign up in seconds and get immediate access to bookable study spaces.',
    },
    {
      title: 'Real-Time Seat Availability',
      description:
        'No more wandering around. See exactly which seats are free right now.',
    },
    {
      title: 'Instant Support Tickets',
      description:
        'Report issues with lights, Wi-Fi, or seating directly through the app.',
    },
  ];
  ...
  libraryFeatures = [
    {
      ...
      description:
        'Automate booking logs and user management. No more manual entries.',
    },
    {
      title: 'Automatic Revenue Tracking',
      description:
        'Get clear insights into your earnings and occupancy rates without lifting a finger.',
    },
    {
      title: 'Improved Student Satisfaction',
      description:
        'Provide a modern, reliable service that keeps students coming back.',
    },
  ];
  pricingPlans = [
    {
