...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./manager/student-applications/student-applications.page').then( m => m.StudentApplicationsPage)
  },
  {
    path: 'student-application-detail',
    loadComponent: () => import('./manager/student-application-detail/student-application-detail.page').then( m => m.StudentApplicationDetailPage)
  },
  {
    path: 'dashboard',
  ...
  },
  {
    ...
    loadComponent: () => import('./admin/library-request-detail/library-request-detail.page').then( m => m.LibraryRequestDetailPage)
  },
  {
    path: 'user-feedback',
